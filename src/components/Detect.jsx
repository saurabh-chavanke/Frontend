...
function Detect() {
  ...
  const [imagePreview, setImagePreview] = useState(null); // Store original uploaded image preview
  ...
  const processImage = async () => {
    ...
    try {
      const response = await axios.post("https://backend-5-h3gh.onrender.com/process", formData);
